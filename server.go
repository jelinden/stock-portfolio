...
func main() {
	...
	router.Handle("GET", "/", middleware.HttpLogger(index))
	router.Handle("GET", "/login", middleware.HttpLogger(index))
	router.Handle("GET", "/signup", middleware.HttpLogger(index))
	router.Handle("GET", "/portfolio/:id", middleware.HttpLogger(index))
	router.Handle("POST", "/login", middleware.HttpLogger(routes.Login))
	router.Handle("GET", "/logout", middleware.HttpLogger(routes.Logout))
